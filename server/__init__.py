...
def add_api_endpoints(app):
    ...
    api.add_resource(
        ProjectAdminAPI,
        "/api/v2/admin/project",
        endpoint="create_project",
        methods=["PUT"],
    )
    api.add_resource(
        ProjectAdminAPI,
        "/api/v2/admin/project/<int:project_id>",
        methods=["GET", "POST", "DELETE"],
    )
    api.add_resource(
        ProjectCommentsAPI, "/api/v2/admin/project/<int:project_id>/comments"
    )
    api.add_resource(
        ProjectInvalidateAll, "/api/v2/admin/project/<int:project_id>/invalidate-all"
    )
    api.add_resource(
        ProjectValidateAll, "/api/v2/admin/project/<int:project_id>/validate-all"
    )
    api.add_resource(ProjectMapAll, "/api/v2/admin/project/<int:project_id>/map-all")
    api.add_resource(
        ProjectResetBadImagery,
        "/api/v2/admin/project/<int:project_id>/reset-all-badimagery",
    )
    api.add_resource(
        ProjectResetAll, "/api/v2/admin/project/<int:project_id>/reset-all"
    )
    api.add_resource(
        ProjectsMessageAll, "/api/v2/admin/project/<int:project_id>/message-all"
    )
    api.add_resource(ProjectTransfer, "/api/v2/admin/project/<int:project_id>/transfer")
    api.add_resource(ProjectsForAdminAPI, "/api/v2/admin/my-projects")
    api.add_resource(ApplicationAPI, "/api/v2/application", methods=["POST", "GET"])
    api.add_resource(
        ApplicationAPI,
        "/api/v2/application/<string:application_key>",
    ...
    api.add_resource(LoginAPI, "/api/v2/auth/login")
    ...
    api.add_resource(ProjectSearchAPI, "/api/v2/project/search")
    api.add_resource(ProjectSearchBBoxAPI, "/api/v2/projects/within-bounding-box")
    api.add_resource(ProjectAPI, "/api/v2/project/<int:project_id>")
    api.add_resource(ProjectAOIAPI, "/api/v2/project/<int:project_id>/aoi")
    api.add_resource(ProjectChatAPI, "/api/v2/project/<int:project_id>/chat")
    api.add_resource(
        HasUserTaskOnProject, "/api/v2/project/<int:project_id>/has-user-locked-tasks"
    )
    api.add_resource(
        HasUserTaskOnProjectDetails,
        "/api/v2/project/<int:project_id>/has-user-locked-tasks/details",
    )
    api.add_resource(
        MappedTasksByUser, "/api/v2/project/<int:project_id>/mapped-tasks-by-user"
    )
    api.add_resource(ProjectSummaryAPI, "/api/v2/project/<int:project_id>/summary")
    api.add_resource(TasksAsJson, "/api/v2/project/<int:project_id>/tasks")
    api.add_resource(TasksAsGPX, "/api/v2/project/<int:project_id>/tasks_as_gpx")
    api.add_resource(TasksAsOSM, "/api/v2/project/<int:project_id>/tasks-as-osm-xml")
    api.add_resource(
        LockTaskForMappingAPI,
        "/api/v2/project/<int:project_id>/task/<int:task_id>/lock-for-mapping",
    )
    api.add_resource(
        UndoMappingAPI,
        "/api/v2/project/<int:project_id>/task/<int:task_id>/undo-mapping",
    )
    api.add_resource(
        MappingTaskAPI, "/api/v2/project/<int:project_id>/task/<int:task_id>"
    )
    api.add_resource(
        UnlockTaskForMappingAPI,
        "/api/v2/project/<int:project_id>/task/<int:task_id>/unlock-after-mapping",
    )
    api.add_resource(
        StopMappingAPI,
        "/api/v2/project/<int:project_id>/task/<int:task_id>/stop-mapping",
    )
    api.add_resource(
        CommentOnTaskAPI, "/api/v2/project/<int:project_id>/task/<int:task_id>/comment"
    )
    api.add_resource(
        LockTasksForValidationAPI,
        "/api/v2/project/<int:project_id>/lock-for-validation",
    )
    api.add_resource(
        UnlockTasksAfterValidationAPI,
        "/api/v2/project/<int:project_id>/unlock-after-validation",
    )
    api.add_resource(
        StopValidatingAPI, "/api/v2/project/<int:project_id>/stop-validating"
    )
    api.add_resource(
        StatsContributionsAPI, "/api/v2/stats/project/<int:project_id>/contributions"
    )
    api.add_resource(
        StatsContributionsByDayAPI,
        "/api/v2/stats/project/<int:project_id>/contributions/day",
    )
    api.add_resource(
        TaskAnnotationsAPI,
    ...
    api.add_resource(
        StatsActivityAPI, "/api/v2/stats/project/<int:project_id>/activity"
    )
    api.add_resource(StatsProjectAPI, "/api/v2/stats/project/<int:project_id>")
    api.add_resource(
        StatsProjectUserAPI,
        "/api/v2/stats/project/<int:project_id>/user/<string:username>",
    )
    api.add_resource(StatsUserAPI, "/api/v2/stats/user/<string:username>")
    api.add_resource(HomePageStatsAPI, "/api/v2/stats/summary")
    ...
    api.add_resource(UserAPI, "/api/v2/user/<string:username>")
    api.add_resource(UserUpdateAPI, "/api/v2/user/update-details")
    api.add_resource(
        UserSetExpertMode, "/api/v2/user/set-expert-mode/<string:is_expert>"
    )
    api.add_resource(
        UserMappedProjects, "/api/v2/user/<string:username>/mapped-projects"
    )
    api.add_resource(
        UserInvalidatedTasks, "/api/v2/user/<string:username>/invalidated-tasks"
    )
    api.add_resource(UserOSMAPI, "/api/v2/user/<string:username>/osm-details")
    api.add_resource(
        UserSetRole, "/api/v2/user/<string:username>/set-role/<string:role>"
    )
    api.add_resource(
        UserSetLevel, "/api/v2/user/<string:username>/set-level/<string:level>"
    )
    api.add_resource(UserAcceptLicense, "/api/v2/user/accept-license/<int:license_id>")
    api.add_resource(UserIdAPI, "/api/v2/user-id/<int:userid>")
    api.add_resource(UserContributionsAPI, "/api/v2/user-id/<int:userid>/contributions")
    api.add_resource(IntersectingTilesAPI, "/api/v2/grid/intersecting-tiles")
    api.add_resource(
        SplitTaskAPI, "/api/v2/project/<int:project_id>/task/<int:task_id>/split"
    )
    api.add_resource(LanguagesAPI, "/api/v2/settings")
