...
class EnvironmentConfig:
    ...
    SUPPORTED_LANGUAGES = {
        ...
        "languages": os.getenv(
            ...
            "Arabic, Česky, Dansk, Deutsch, English, Español, Persian (Iran), Suomi, Français, Magyar, Galician, Indonesia, Italiano, 日本語, 한국어, Lietuvos, Malagasy, Bokmål, Nederlands, Polish, Português, Português (Brasil), Русский, සිංහල, Slovenščina, Kiswahili, தமிழ், Tagalog, Türkçe, Українська, tiếng Việt, 中文",  # noqa
        ),
    }
