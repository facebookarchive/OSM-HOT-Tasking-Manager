...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('tasks', sa.Column('assigned_to', sa.BIGINT(), autoincrement=False, nullable=True))
    op.create_foreign_key('fk_users_assigned_to', 'tasks', 'users', ['assigned_to'], ['id'])
    op.add_column('projects', sa.Column('enforce_task_assignment', sa.BOOLEAN(), autoincrement=False, nullable=True))
    op.add_column('projects', sa.Column('prevent_adjacent_task_lock', sa.BOOLEAN(), autoincrement=False, nullable=True))
    ...
    sa.Column('unassigned_date', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('assignment_history_id', sa.INTEGER(), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='task_assignment_history_project_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='osmcha_project_id_fkey'),
